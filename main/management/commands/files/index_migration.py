...
class Migration(Migration):
    ...
    operations = [
        ...
        RunSQL('CREATE INDEX main_cpcgroup_group_idx ON main_cpcgroup USING GIN ("group" gin_trgm_ops);', 
        ...
        RunSQL("CREATE INDEX main_patent_title_abstract_idx ON main_patent USING GIN (title gin_trgm_ops, abstract gin_trgm_ops);",
        ...
        RunSQL("CREATE INDEX f ON main_assignee USING GIN (organization gin_trgm_ops);",
