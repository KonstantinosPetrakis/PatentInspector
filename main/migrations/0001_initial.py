# Generated by Django 4.1.7 on 2023-04-06 16:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patent', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='pct_data', to='main.patent')),
            ],
        ),
        migrations.CreateModel(
            name='PatentCitation',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('citation_date', models.DateField(help_text='The date when the patent was cited.', null=True)),
                ('record_name', models.CharField(blank=True, help_text='The name of the record.', max_length=150, null=True)),
                ...
                ('cited_patent_country', models.CharField(help_text="The country code of the cited patent if it's not in the database.", max_length=100, null=True)),
                ...
                ('citing_patent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='citations', to='main.patent')),
            ],
        ),
        migrations.CreateModel(
            name='Inventor',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_name', models.CharField(blank=True, help_text='The first name of the inventor.', max_length=100, null=True)),
                ('last_name', models.CharField(blank=True, help_text='The last name of the inventor.', max_length=100, null=True)),
                ...
                ('location', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='inventors', to='main.location')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_name', models.CharField(blank=True, help_text='The first name of the assignee if the assignee is an individual.', max_length=100, null=True)),
                ('last_name', models.CharField(blank=True, help_text='The last name of the assignee if the assignee is an individual.', max_length=100, null=True)),
                ...
                ('location', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='assignees', to='main.location')),
