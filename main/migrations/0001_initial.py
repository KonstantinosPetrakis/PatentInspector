...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CPCGroup',
            fields=[
                ('cpc_group', models.CharField(help_text="The group of the CPC classification. E.g 'A63B71/146'", max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpc_subgroup', models.ForeignKey(help_text='The CPC subgroup of the patent.', on_delete=django.db.models.deletion.PROTECT, related_name='patents', to='main.cpcgroup')),
            ],
        ),
        migrations.CreateModel(
            name='PCTData',
        ...
        migrations.AddField(
            model_name='cpcgroup',
            name='cpc_subclass',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='groups', to='main.cpcsubclass'),
        ),
        migrations.AddField(
            model_name='cpcclass',
            name='section',
